...
Helps you with: [split settings](https://docs.djangoproject.com/en/stable/topics/settings/), [database config](https://docs.djangoproject.com/en/stable/ref/settings/#databases), [custom user model](https://docs.djangoproject.com/en/stable/topics/auth/customizing/#substituting-a-custom-user-model), [static files](https://docs.djangoproject.com/en/stable/howto/static-files/), [media files](https://docs.djangoproject.com/en/stable/topics/files/), [security headers](https://docs.djangoproject.com/en/stable/topics/security/), [logging config](https://docs.djangoproject.com/en/stable/topics/logging/), [cache config](https://docs.djangoproject.com/en/stable/topics/cache/), [email config](https://docs.djangoproject.com/en/stable/topics/email/), [translations](https://docs.djangoproject.com/en/stable/topics/i18n/translation/), [admin](https://docs.djangoproject.com/en/stable/ref/contrib/admin/), [Python package manager](https://docs.astral.sh/uv/), [env-driven settings](https://django-environ.readthedocs.io/), [password + social login](https://docs.allauth.org/), [passwordless magic-link login](https://django-mail-auth.readthedocs.io/), [brute-force lockout](https://django-axes.readthedocs.io/), [2FA for allauth](https://docs.allauth.org/en/latest/mfa/introduction.html), [TOTP 2FA](https://django-otp-official.readthedocs.io/), [distributed task queue](https://docs.celeryq.dev/), [built-in Django tasks](https://docs.djangoproject.com/en/dev/topics/tasks/), [DB-backed tasks](https://github.com/RealOrangeOne/django-tasks-database), [Redis-backed tasks](https://github.com/RealOrangeOne/django-tasks-rq), [simple Redis job queue](https://python-rq.org/), [Redis cache backend](https://github.com/jazzband/django-redis), [static files in prod](https://whitenoise.evans.io/), [S3 storage backend](https://django-storages.readthedocs.io/), [self-hosted S3](https://min.io/docs/minio/linux/), [SQLite replication](https://litestream.io/), [transactional email providers](https://anymail.dev/), [local SMTP capture](https://mailpit.axllent.org/), [Tailwind without Node](https://django-tailwind-cli.readthedocs.io/), [Tailwind component library](https://daisyui.com/), [CORS headers](https://github.com/adamchainz/django-cors-headers), [typed REST API](https://django-modern-rest.readthedocs.io/), [high-perf REST](https://django-bolt.readthedocs.io/), [payments SDK](https://docs.stripe.com/api?lang=python), [Stripe model sync](https://dj-stripe.dev/), [privacy-friendly web analytics](https://www.goatcounter.com/help/start), [self-hosted analytics](https://umami.is/docs), [single-user analytics](https://shynet.r1ke.io/), [Google Analytics](https://developers.google.com/analytics/devguides/collection/ga4), [Content Security Policy](https://django-csp.readthedocs.io/), [error reporting (SaaS)](https://docs.sentry.io/platforms/python/integrations/django/), [error reporting (self-host)](https://www.bugsink.com/docs/), [error reporting (open-source)](https://glitchtip.com/documentation), [N+1 query detection](https://github.com/PedroBern/django-zeal), [migration safety lint](https://github.com/3YOURMIND/django-migration-linter), [migration tests](https://django-test-migrations.readthedocs.io/), [request profiling](https://github.com/jazzband/django-silk), [debug toolbar](https://github.com/kmmbvnr/django-orbit), [shell_plus + management commands](https://django-extensions.readthedocs.io/), [linter & formatter](https://docs.astral.sh/ruff/), [type checker](https://microsoft.github.io/pyright/), [Django type stubs](https://github.com/typeddjango/django-stubs), [git hooks](https://pre-commit.com/), [pytest for Django](https://pytest-django.readthedocs.io/), [structured logging](https://www.structlog.org/), [database backups](https://django-dbbackup.readthedocs.io/), [containers](https://docs.docker.com/compose/), [reverse proxy with auto-HTTPS](https://caddyserver.com/docs/), [Fly.io deploy](https://fly.io/docs/django/), [Railway deploy](https://docs.railway.com/), [Render deploy](https://render.com/docs), [CI](https://docs.github.com/en/actions), [reproducible dev env](https://containers.dev/)
