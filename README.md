...
Helps you with: [split settings](https://docs.djangoproject.com/en/stable/topics/settings/), [DATABASE_URL](https://docs.djangoproject.com/en/stable/ref/settings/#databases), [custom user model](https://docs.djangoproject.com/en/stable/topics/auth/customizing/#substituting-a-custom-user-model), [static files](https://docs.djangoproject.com/en/stable/howto/static-files/), [media files](https://docs.djangoproject.com/en/stable/topics/files/), [security headers](https://docs.djangoproject.com/en/stable/topics/security/), [logging](https://docs.djangoproject.com/en/stable/topics/logging/), [caching](https://docs.djangoproject.com/en/stable/topics/cache/), [email](https://docs.djangoproject.com/en/stable/topics/email/), [translations](https://docs.djangoproject.com/en/stable/topics/i18n/translation/), [admin](https://docs.djangoproject.com/en/stable/ref/contrib/admin/), [Python deps & venvs](https://docs.astral.sh/uv/), [env-driven settings](https://django-environ.readthedocs.io/), [password + social login](https://docs.allauth.org/), [passwordless magic-link login](https://django-mail-auth.readthedocs.io/), [brute-force lockout](https://django-axes.readthedocs.io/), [2FA via allauth](https://docs.allauth.org/en/latest/mfa/introduction.html), [standalone 2FA](https://django-otp-official.readthedocs.io/), [distributed task queue](https://docs.celeryq.dev/), [built-in Django tasks](https://docs.djangoproject.com/en/dev/topics/tasks/), [DB-backed tasks](https://github.com/RealOrangeOne/django-tasks-database), [Redis-backed tasks](https://github.com/RealOrangeOne/django-tasks-rq), [Redis job queue](https://python-rq.org/), [Redis cache backend](https://github.com/jazzband/django-redis), [static files in prod](https://whitenoise.evans.io/), [S3 storage backend](https://django-storages.readthedocs.io/), [self-hosted S3](https://min.io/docs/minio/linux/), [SQLite replication](https://litestream.io/), [transactional email](https://anymail.dev/), [local SMTP capture](https://mailpit.axllent.org/), [Tailwind without Node](https://django-tailwind-cli.readthedocs.io/), [Tailwind component library](https://daisyui.com/), [CORS headers](https://github.com/adamchainz/django-cors-headers), [typed REST API](https://django-modern-rest.readthedocs.io/), [fast REST framework](https://django-bolt.readthedocs.io/), [payments](https://docs.stripe.com/api?lang=python), [Stripe model sync](https://dj-stripe.dev/), [privacy-first analytics](https://www.goatcounter.com/help/start), [self-hosted analytics](https://umami.is/docs), [single-tenant analytics](https://shynet.r1ke.io/), [Google Analytics](https://developers.google.com/analytics/devguides/collection/ga4), [Content Security Policy](https://django-csp.readthedocs.io/), [hosted error tracking](https://docs.sentry.io/platforms/python/integrations/django/), [self-hosted error tracking](https://www.bugsink.com/docs/), [Sentry-compatible error tracking](https://glitchtip.com/documentation), [N+1 query detection](https://github.com/PedroBern/django-zeal), [migration safety checks](https://github.com/3YOURMIND/django-migration-linter), [migration tests](https://django-test-migrations.readthedocs.io/), [request profiling](https://github.com/jazzband/django-silk), [debug toolbar](https://github.com/kmmbvnr/django-orbit), [shell_plus & extra commands](https://django-extensions.readthedocs.io/), [linter & formatter](https://docs.astral.sh/ruff/), [type checker](https://microsoft.github.io/pyright/), [Django type stubs](https://github.com/typeddjango/django-stubs), [git hooks](https://pre-commit.com/), [pytest for Django](https://pytest-django.readthedocs.io/), [structured logging](https://www.structlog.org/), [database backups](https://django-dbbackup.readthedocs.io/), [Docker images & compose](https://docs.docker.com/compose/), [reverse proxy with auto-HTTPS](https://caddyserver.com/docs/), [Fly.io deploy](https://fly.io/docs/django/), [Railway deploy](https://docs.railway.com/), [Render deploy](https://render.com/docs), [GitHub Actions CI](https://docs.github.com/en/actions), [reproducible dev env](https://containers.dev/)
